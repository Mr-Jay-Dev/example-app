								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Orders Listing</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
									...
									<div class="card card-flush">
										...
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												...
												<!--begin::Add product-->
												<a href="../../demo38/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add Order</a>
												<!--end::Add product-->
											</div>
											<!--end::Card toolbar-->
										</div>
                                                ...
                                                <tbody class="fw-semibold text-gray-600">    
                                                    ...
                                                    <tr>
														...
														<td data-kt-ecommerce-order-filter="order_id">
															<a href="../../demo38/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">{{ $item->id }}</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																	<a href="../../demo38/dist/apps/user-management/users/view.html">
																		<div class="symbol-label">
																			<img src="{{ asset('/storage/'.$item->avatar) }}" alt="Emma Smith" class="w-100" />
																		</div>
																	</a>
																</div>
																<!--end::Avatar-->
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="../../demo38/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $item->campaign_name }}</a>
																	<!--end::Title-->
																</div>
															</div>
														</td>
														<td class=" pe-0" data-order="Delivering">
															<!--begin::Badges-->
															<div class="badge badge-light-primary">{{ $item->user_role }}</div>
															<!--end::Badges-->
														</td>
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="../../demo38/dist/apps/ecommerce/sales/details.html" class="menu-link px-3">View</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="{{ route('edit-listing', ['id' => $item->id]) }}" data-bs-toggle="modal"
                                                                    data-bs-target="#kt_modal_create_campaign" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
                ...
                <div class="modal-content modal-rounded">
                    ...
                    <div class="modal-body scroll-y m-5">
                        ...
                        <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper">
                            ...
                            <!--end::Nav-->
                            <!--begin::Form-->
                            <form action="{{ route('update', $data->id) }}" method="POST" enctype="multipart/form-data"  class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate">
                                @csrf 
                                <!--begin::Step 1-->
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="campaign_name" placeholder="" value="{{$data->campaign_name}}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            ...
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder"
                                                ...
                                                <label
                                                    ...
                                                    <!--begin::Inputs-->
                                                    <input type="file" value="{{$data->avatar}}" name="avatar" accept=".png, .jpg, .jpeg" />
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_role_option_2">
                                                        ...
                                                        <div class="text-gray-600">Boost telecommunication feedback to provide
                                                            precise and accurate information</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Radio-->
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo38/dist/apps/projects/project.html" class="w-30px me-3" src="media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo38/dist/apps/projects/project.html" class="w-30px me-3" src="media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<!--end::Label-->
											<!--begin::Image input placeholder-->
											<style>.image-input-placeholder { background-image: url('media/svg/files/blank-image.svg'); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('media/svg/files/blank-image-dark.svg'); }</style>
											<!--end::Image input placeholder-->
											<!--begin::Image input-->
