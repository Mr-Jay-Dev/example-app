@include('layouts.nav')
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									<!--begin::Form-->
									<form  action="{{ route('update', $data->id) }}" method="POST" class="form d-flex flex-column flex-lg-row">
										<!--begin::Aside column-->
										<!--end::Aside column-->
										<!--begin::Main column-->
                                        {{csrf_field()}}
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                                        ...
                                                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
                                                                            ...
                                                                            <div class="row mb-5">
                                                                                ...
                                                                                <div class="col-md-6 fv-row">
                                                                                    ...
                                                                                    <!--end::Label-->
                                                                                    <!--begin::Input-->
                                                                                    <input type="text" value="{{$data->firstname}}" class="form-control form-control-solid" placeholder=""
                                                                                        name="firstname" />
                                                                                    <!--end::Input-->
                                                                                </div>
                                                                                <!--end::Col-->
                                                                                ...
                                                                                <div class="col-md-6 fv-row">
                                                                                    ...
                                                                                    <!--end::Label-->
                                                                                    <!--end::Input-->
                                                                                    <input type="text" value="{{$data->lastname}}" class="form-control form-control-solid" placeholder=""
                                                                                        name="lastname" />
                                                                                    <!--end::Input-->
                                                                                </div>
                                                                                <!--end::Col-->
                                                                            ...
                                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--begin::Select-->
                                                                                <select name="country" value="{{$data->country}}" data-control="select2"
                                                                            ...
                                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--begin::Input-->
                                                                                <input value="{{$data->address1}}" class="form-control form-control-solid" placeholder="" name="address1" />
                                                                                <!--end::Input-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <!--begin::Input group-->
                                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--begin::Input-->
                                                                                <input value="{{$data->address2}}" class="form-control form-control-solid" placeholder="" name="address2" />
                                                                                <!--end::Input-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <!--begin::Input group-->
                                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--begin::Input-->
                                                                                <input value="{{$data->city}}" class="form-control form-control-solid" placeholder="" name="city" />
                                                                                <!--end::Input-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <!--begin::Input group-->
                                                                            <div class="row g-9 mb-5">
                                                                                ...
                                                                                <div class="col-md-6 fv-row">
                                                                                    ...
                                                                                    <!--end::Label-->
                                                                                    <!--begin::Input-->
                                                                                    <input value="{{$data->state}}" class="form-control form-control-solid" placeholder=""
                                                                                        name="state" />
                                                                                    <!--end::Input-->
                                                                                </div>
                                                                                <!--end::Col-->
                                                                                ...
                                                                                <div class="col-md-6 fv-row">
                                                                                    ...
                                                                                    <!--end::Label-->
                                                                                    <!--begin::Input-->
                                                                                    <input value="{{$data->postcode}}" class="form-control form-control-solid" placeholder=""
                                                                                        name="postcode" />
                                                                                    <!--end::Input-->
                                                                                </div>
                                                                                <!--end::Col-->
                                                                                ...
                                                                                <div class="d-flex flex-stack">
                                                                                    ...
                                                                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                                                                        ...
                                                                                        <input class="form-check-input" name="billing" type="checkbox"
                                                                                            value="1" value="{{$data->billing}}" checked="checked" />
                                                                                        <!--end::Input-->
                                                                                        <!--begin::Label-->
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="../../demo38/dist/apps/ecommerce/catalog/products.html" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
												<!--end::Button-->
												<!--begin::Button-->
		...
		<script src="js/custom/apps/ecommerce/catalog/save-product.js"></script>
