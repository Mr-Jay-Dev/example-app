                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-px text-center pt-15 pb-15">
                            <!--begin::Title-->
                            <h2 class="fs-2x fw-bold mb-0">New User</h2>
                            <!--end::Title-->
                            <!--begin::Description-->
                            <p class="text-gray-400 fs-4 fw-semibold py-7">Click on the below buttons to launch
                                <br />a new address example.
                            </p>
                            <!--end::Description-->
                            <!--begin::Action-->
                            <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_new_address">Add New User</a>
                            <!--end::Action-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Illustration-->
                        <div class="text-center pb-15 px-5">
                            <img src="media/illustrations/sketchy-1/19.png" alt=""
...
<div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('adduserdata') }}"  method="POST" id="kt_modal_new_address_form">
                @csrf
                <!--begin::Modal header-->
...
{{-- <script src="js/custom/utilities/modals/new-address.js"></script> --}}
