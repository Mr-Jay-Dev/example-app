                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_new_address">Add User</a>
                            <!--end::Add product-->
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    ...
                    <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                <!--begin::Form-->
                                <form class="form" action="{{ route('adduserdata') }}" method="POST"
                                        ...
                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll"
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Label-->
                                                        <label class="fs-5 fw-semibold">Use as a billing
                                                            adderess?</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                    ...
                                                    <label
                                                        ...
                                                        <!--begin::Label-->
                                                        <span
                                                            class="form-check-label fw-semibold text-muted">Yes</span>
                                                        <!--end::Label-->
                                                    </label>
                                                    <!--end::Switch-->
                                                </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="">Id</th>
                                    <th class="min-w-20px">First Name</th>
                                    <th class="text-end min-w-50px">Last Name</th>
                                    <th class="text-end min-w-70px">Country</th>
                                    <th class="text-end min-w-50px">Address1</th>
                                    <th class="text-end min-w-50px">Address2</th>
                                    <th class="text-end min-w-50px">City</th>
                                    <th class="text-end min-w-50px">State</th>
                                    <th class="text-end min-w-50px">Postcode</th>
                                    <th class="text-end min-w-50px">Billing</th>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="../../demo38/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        data-kt-ecommerce-product-filter="product_name">{{ $item->firstname }}</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-end pe-0">
                                            <span class="fw-bold">{{ $item->lastname }}</span>
                                        </td>
                                        <td class="text-end pe-0" data-order="17">
                                            <span class="fw-bold ms-3">{{ $item->country }}</span>
                                        </td>
                                        <td class="text-end pe-0">{{ $item->address1 }}</td>
                                        <td class="text-end pe-0" data-order="rating-5">
                                            {{ $item->address2 }}
                                        </td>
                                        <td class="text-end pe-0" data-order="Published">
                                            <!--begin::Badges-->
                                            <div class="badge badge-light-success">{{ $item->city }}</div>
                                            <!--end::Badges-->
                                        </td>
                                        <td class="text-end pe-0" data-order="17">
                                            <span class="fw-bold ms-3">{{ $item->state }}</span>
                                        </td>
                                        <td class="text-end pe-0" data-order="17">
                                            <span class="fw-bold ms-3">{{ $item->postcode }}</span>
                                        </td>
                                        <td class="text-end pe-0" data-order="17">
                                            <span class="fw-bold ms-3">{{ $item->billing }}</span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{ route('delete', ['id' => $item->id]) }}">
                                                        @method('DELETE')
                                                        <button style="{border: none}" class="menu-link px-3">
                                                            Delete
                                                        </button>
                                                    </form>
                                                </div>
...
<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
    ...
    <div class="card shadow-none border-0 rounded-0">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="../../demo38/dist/apps/projects/project.html" class="w-30px me-3"
        ...
        <div class="card-footer py-5 text-center" id="kt_activities_footer">
            <a href="../../demo38/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View All
                Activities
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input class="form-control d-flex align-items-center" value=""
                                        id="kt_modal_create_campaign_location" data-kt-flags-path="media/flags/" />
                                    <!--end::Tagify-->
                                </div>
                                <!--end::Input group-->
                            </div>
